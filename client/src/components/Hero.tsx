      ...
      <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
        <div className="max-w-lg text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/products"
              className="bg-blush-pink text-white px-8 py-4 rounded-full font-semibold hover:bg-blush-pink/90 transition-colors text-center"
            >
              Shop New Arrivals
            </Link>
            <Link
              href="/products"
              className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-deep-plum transition-colors text-center"
            >
              Explore Categories
            </Link>
          </div>
